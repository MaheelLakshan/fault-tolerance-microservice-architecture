      ...
      <div className="flex flex-col gap-12">
        <div className="">
          <div className="flex items-center gap-8">
            ...
            <h2 className="text-xl font-bold tracking-widest">Rs. {total}</h2>
          </div>
        ...
        <button disabled={isPending} className="bg-black px-5 py-3 text-white rounded-full flex items-center gap-4 w-max cursor-pointer hover:bg-gray-700 transition-all duration-300 disabled:cursor-not-allowed" onClick={() => mutate(cart)}>
